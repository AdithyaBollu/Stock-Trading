...
## 2026-05-14 — Market Open (Week 4 Day 4, Thursday)
| Date | Ticker | Sleeve | Side | Shares | Entry | Stop (10% trail GTC) | Thesis | Target | R:R |
|------|--------|--------|------|--------|-------|----------------------|--------|--------|-----|
| 2026-05-14 | CSCO | alpha | buy | 8 | $118.3175 | $106.56 trail GTC (HWM $118.40) | Q3 FY26 beat+raise post-AMC 5/13: rev $15.8B (+12% YoY, beat ~$240M), non-GAAP EPS $1.06 (+10%), FY26 guide RAISED to $62.8-63.0B from $61.2-61.7B on AI infrastructure orders. Gap-up +15.3% (prev close $101.91 → open $117.55), pullback to $115.08 held the gap, reclaimed HOD $119.35 holding above VWAP $117.92 = textbook pullback-on-reclaim per Tuesday playbook | $133.11 (+12.5%) | 1.25:1 |

**Notes:** CSCO post-earnings drift entry — the cleanest catalyst-driven setup flagged on Tuesday's calendar, executed cleanly. Conditions all met: clean beat+raise (rev/EPS beat, FY26 guide raised), gap-up +15.3% (far exceeds the >+3% gate), and a confirmed pullback-on-reclaim (open $117.55 → low $115.08 held the gap → reclaimed to HOD $119.35, holding $118-119 above VWAP — not a vertical chase). Filled 8 sh @ $118.3175 = $946.54 cost / 9.5% of $9,946.83 equity (within alpha cap; sized to the Tuesday-planned ~10%). 10% trailing stop GTC placed immediately, stop $106.56 / HWM $118.40. Target +12.5% = $133.11, R:R 1.25:1 (clears the 1.2:1 alpha minimum). Rule check all clear: positions 2→3/10, weekly trades 0→1/15, daytrade count 0/5 rolling, catalyst documented in today's RESEARCH-LOG. HOLD AAPL (+4.43% from entry) and GOOGL (+8.07%) — both drifts thesis-intact, trails doing the work, no adds/trims. Niche sleeve stays empty. AMAT Q2 AMC tonight — no pre-print exposure, post-print drift candidate for Fri. Trades this week: 1/15. Open positions: 3/10. Daytrade count: 0/5 rolling. Cash post-fill ~$7,309 (~73%). Alpha sleeve now ~$2,637 (~26.5%).
